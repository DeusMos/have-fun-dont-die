...
| [bioelectricity](./bioelectricity/report.md) | [report.md](./bioelectricity/report.md) | September 4, 2026 | Levin-lab ion-channel mRNA, pump drugs, and GJ block change frog/planaria anatomy (7.5% complete ectopic eyes; 25% octanol two-heads); BioDome is silk+5 drugs, not a voltage-dye rewrite; aging is a 2024 perspective plus keratinocyte dish, not a human Vmem trial. |
<!-- END GENERATED -->
